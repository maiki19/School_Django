...
class QuizCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        quiz.save()
        messages.success(self.request, 'Este Examen fue Cargado con Exito! Empieza ahora mismo y agrega algunas preguntas.')
...
class QuizDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request, 'El Examen %s fue borrado con exito!' % quiz.name)
...
def question_add(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question.quiz = quiz
            question.save()
            messages.success(request, 'Ahora puedes agregar respuestas/opciones a la pregunta.')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and formset.is_valid():
            with transaction.atomic():
                form.save()
                formset.save()
            messages.success(request, 'Preguntas y Respuestas Cargadas!')
            return redirect('teachers:quiz_change', quiz.pk)
    else:
...
class QuestionDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        question = self.get_object()
        messages.success(request, 'La pregunta %s fue eliminada con exito!' % question.text)
        return super().delete(request, *args, **kwargs)
